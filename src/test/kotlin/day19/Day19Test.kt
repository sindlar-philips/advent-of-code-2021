...
internal class Day19Test {
    ...
    fun normalize1() {
        ...
        val actual = Day19.normalize(2, scanner1, scanner2)
        assertEquals(expected, actual)
    }

    @Test
    fun normalize2() {
        val reference = Day19.scanners[0]
        val rotations = Day19.scanners[1].allOrientations()
        val normalized = rotations.mapNotNull { Day19.normalize(12, reference, it) }.single()
    ...
    @Test
    fun countBeacons() {
        assertEquals(79, Day19.countBeacons())
    }

    @Test
    fun manhattanDistance() {
        assertEquals(3621, Day19.manhattanDistance())
    }
}