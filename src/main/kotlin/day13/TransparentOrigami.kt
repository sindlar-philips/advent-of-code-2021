...
object TransparentOrigami : Runnable {

    private val dots = PuzzleData.load("/day13/dots.txt") { parseDots(it) }
    private val instructions = PuzzleData.load("/day13/instructions.txt") { parseInstructions(it) }
